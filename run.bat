...
if not defined JAVA_HOME if exist "C:\Program Files\Eclipse Adoptium\jdk-24*\bin\java.exe" (
    for /d %%D in ("C:\Program Files\Eclipse Adoptium\jdk-24*") do set "JAVA_HOME=%%~fD"
)

if not defined JAVA_HOME if exist "C:\Program Files\Java\jdk-24\bin\java.exe" (
