 ...
 * Write methods accept an existing Connection to participate in the caller's transaction.
...
public final class KeyService {
     ...
     */
    public static void save(Connection conn, int fileId, byte[] wrappedDEK, byte[] iv)
            throws Exception {
